...
SRCS =	allocate_arrays1.f90 bcast2.f90 bcast3.f90 build_trees.f90 \
	...
	deserialize_trees2.f90 enorm.f90 fasham_CDOM_GP_module.f90 \
	fasham_CDOM_module.f90 Fasham_Forcing.f90 fasham_model_debug.f90 \
	fasham_tree_functions.f90 fasham_tree_interfaces.f90 \
	fasham_variables_module.f90 fcn.f90 fdjac2.f90 GA_calc_fitness.f90 \
	GA_check_for_elite.f90 GA_Fitness_Proportionate_Reproduction.f90 \
	GA_Mutations.f90 GA_parameters_module.f90 GA_random_recruit.f90 \
	GA_save_elites.f90 GA_Tournament_Style_Sexual_Reproduction.f90 \
	GA_variables_module.f90 Generate_Dot_Graph.f90 GP_calc_fitness.f90 \
	...
	GP_random_recruit.f90 GP_ranking_sort.f90 \
	...
	read_generic_input_data.f90 read_input_data.f90 \
	Runge_Kutta_Box_Model.f90 Runge_Kutta_Box_Model_data.f90 \
	select_best_RK_lmdif_result.f90 set_answer_arrays.f90 \
	set_forcing_node.f90 set_modified_indiv.f90 setup1.f90 \
	setup_math_functions.f90 setup_output_unit.f90 setup_run_fcn.f90 \
	setup_run_para_lmdif.f90 sort.f90 sse0_calc.f90 sse0_calc_log10.f90 \
	summary_GP_all.f90 summary_GP_indiv.f90 summary_GP_minSSE_indiv.f90 \
	swap_module.f90 Tree_Helper_module.f90 tree_node_factory_module.f90 \
	twin_module.f90
...
OBJS =	allocate_arrays1.o bcast2.o bcast3.o build_trees.o calc_stats.o \
	...
	create_tree_node_string.o deallocate_arrays1.o deserialize_trees2.o \
	enorm.o fasham_CDOM_GP_module.o fasham_CDOM_module.o Fasham_Forcing.o \
	...
	GA_Mutations.o GA_parameters_module.o GA_random_recruit.o \
	...
	GP_produce_first.o GP_produce_next.o GP_random_recruit.o \
	...
	read_all_summary_file.o read_cntl_vars.o read_generic_input_data.o \
	read_input_data.o Runge_Kutta_Box_Model.o \
	Runge_Kutta_Box_Model_data.o select_best_RK_lmdif_result.o \
	set_answer_arrays.o set_forcing_node.o set_modified_indiv.o setup1.o \
...
deserialize_trees2.o: GP_variables_module.o Tree_Helper_module.o \
	...
	mpi_module.o tree_node_factory_module.o
enorm.o: kinds_mod.o
fasham_CDOM_GP_module.o: GA_parameters_module.o GA_variables_module.o \
	GP_data_module.o GP_parameters_module.o GP_variables_module.o \
	fasham_tree_interfaces.o fasham_variables_module.o kinds_mod.o \
	mpi_module.o twin_module.o
...
GA_random_recruit.o: GA_parameters_module.o GA_variables_module.o \
	GP_data_module.o GP_parameters_module.o GP_variables_module.o \
	kinds_mod.o
...
GP_produce_next.o: GA_parameters_module.o GA_variables_module.o \
	...
	class_tree_node.o fasham_variables_module.o kinds_mod.o mpi_module.o \
	tree_node_factory_module.o
GP_random_recruit.o: GA_parameters_module.o GA_variables_module.o \
	GP_parameters_module.o GP_variables_module.o kinds_mod.o mpi_module.o
...
read_cntl_vars.o: GA_parameters_module.o GA_variables_module.o \
	GP_data_module.o GP_parameters_module.o GP_variables_module.o \
	kinds_mod.o mpi_module.o
read_generic_input_data.o: GA_parameters_module.o GA_variables_module.o \
	GP_data_module.o GP_parameters_module.o GP_variables_module.o \
	kinds_mod.o mpi_module.o
