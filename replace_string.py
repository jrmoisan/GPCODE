...
tag_list.append( (  r"min \(", r"MIN (" )  )
tag_list.append( (  r"max \(", r"MAX (" )  )
tag_list.append( (  r"_MIN", r"_min" )  )
tag_list.append( (  r"_MAX", r"_max" )  )
...
tag_list.append( (  'GPGACODE_DATA','GPGACODE_data' )  )
tag_list.append( (  '_DATA','_data' )  )
...
tag_list.append( (  r"inquire\(", r"INQUIRE (" )  )
